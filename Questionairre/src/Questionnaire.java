...
public interface Questionnaire {
  ...
  /**
   * Helper function to get the identifier of the Question.
   *
   * @param q the question being passed in.
   * @return the String identifier of the question.
   * @throws NoSuchElementException if the question cannot be found in the questionnaire.
   */
   ...
   * questionnaire. The first question added would be 1, second 2, etc.
   *
   ...
   * questions in the returned questionnaire are copies of the original questions.
   *
  ...
  /**
   * Convert the questionnaire into a single string in the format of Question: [prompt] then two
   * newlines Answer: [answer] two newlines, and so on.
   */
  String toString();
